...
class StatementStudentRepositoryTest {
    ...
    void findById() {
        ...
        Assertions.assertAll(() -> Assertions.assertEquals("student1", studentOptional.get().getId()),
    ...
    void update() {
        ...
        Student findStudent = newStudent.get();

        Assertions.assertAll(() -> Assertions.assertEquals("student1", findStudent.getId()),
                () -> Assertions.assertEquals("엔에이치엔아카데미", findStudent.getName()),
                () -> Assertions.assertEquals(Student.GENDER.F, findStudent.getGender()),
                () -> Assertions.assertEquals(30, findStudent.getAge()));
