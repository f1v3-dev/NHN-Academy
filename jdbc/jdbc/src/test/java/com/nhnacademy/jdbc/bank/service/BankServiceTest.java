...
class BankServiceTest {
    ...
    void saveAccount_duplicate_accountNumber() {
        ...
        Assertions.assertThrows(AccountAlreadyExistException.class, () -> bankService.createAccount(null, account));
    }
    ...
    void deposit_account_not_found() {
        ...
        assertThrows(AccountNotFoundException.class,
                () -> bankService.depositAccount(null, Long.MAX_VALUE, Long.MAX_VALUE));
    ...
    void withdraw_account_not_found() {
        ...
        assertThrows(AccountNotFoundException.class,
                () -> bankService.withdrawAccount(null, Long.MAX_VALUE, Long.MAX_VALUE));
        Mockito.verify(accountRepository, Mockito.times(1)).countByAccountNumber(any(), anyLong());
    }
