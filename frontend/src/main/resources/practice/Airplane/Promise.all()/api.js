const flightScheduleApi = (function () {
    ...
    'use strict';
    const SERVICE_KEY = "c6qQcfPklsGaultKCjDIeViFiDNP9etR6cNT5zbvVdtoSPF6O/ezFa1xJIasXh2EGUq0q7uya4ioRrUrLZPp4Q==";
    ...
    */
    ...
    api.search = async function (depAirportId, arrAirportId, depPlandTime) {
        ...
        const items = await Promise.all(promiseList).then((arr) => {
            const initems = [];
